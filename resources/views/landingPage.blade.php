...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="text-[#1b1b18] flex min-h-screen flex-col pb-12">
        ...
        <header class="w-full text-sm fixed z-50 top-0 bg-white border-b border-gray-100 shadow-md">
            @if (Route::has('login'))
                <div class="flex items-center justify-between w-full px-4 sm:px-6 lg:px-8 py-3">
                    <!-- LOGO -->
                    <div class="shrink-0">
                    ...
                    <nav class="flex items-center gap-4">
                        ...
                        @else
                            ...
                            @if (Route::has('register'))
                                <a
                                    href="{{ route('register') }}"
                                    class="inline-block px-5 py-1.5 bg-[#FCD34D] hover:bg-yellow-500 text-white rounded-xl text-sm leading-normal transition-colors duration-200">
                                    Register
                                </a>
                            @endif
                        @endauth
