...
<div>
    ...
    <div class="m-4">
        <div class="flex justify-end my-4 gap-4">
            ...
            <!-- filter sort -->
            <div data-collapse-toggle="filter_guru" class="text-[#F6F7EF] bg-[#2E7D65] hover:bg-[#256D58] flex items-center py-2 px-4 rounded-xl cursor-pointer gap-2">
                <i class="fas fa-filter"></i>
            </div>
        </div>

        <!-- filter dan sort -->
        <div class="bg-[#F6F7EF] border border-[#94A89C] rounded-xl p-4 flex flex-col gap-y-4 mb-4 hidden" id="filter_guru">
            <!-- filter -->
